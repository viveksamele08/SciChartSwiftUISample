 ...
 */
- (instancetype)initWithGradientStyle:(SCIRadialGradientBrushStyle *)gradientStyle antiAliasing:(BOOL)antiAliasing thickness:(float)thickness strokeDashArray:(nullable NSArray<NSNumber *> *)strokeDashArray;
