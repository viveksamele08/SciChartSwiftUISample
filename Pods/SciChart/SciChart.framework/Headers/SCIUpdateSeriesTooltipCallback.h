...
//
// SCIUpdateSeriesTooltipCallback.h is part of SCICHART®, High Performance Scientific Charts
...
@protocol ISCISeriesTooltipCore;
 ...
 */
typedef BOOL (^SCIUpdateSeriesTooltipCallback) (id<ISCISeriesTooltipCore> seriesTooltip, CGPoint point);
