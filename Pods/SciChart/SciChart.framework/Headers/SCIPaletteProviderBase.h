...
//
// SCIPaletteProviderBase.h is part of SCICHART®, High Performance Scientific Charts
 ...
 */
@interface SCIPaletteProviderBase<T : id<ISCIRenderableSeries>> : SCIRenderableSeriesProviderBase<T><ISCIPaletteProvider>
