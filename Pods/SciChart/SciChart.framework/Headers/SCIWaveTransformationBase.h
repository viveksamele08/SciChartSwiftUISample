...
//
// SCIWaveTransformationBase.h is part of SCICHART®, High Performance Scientific Charts
 ...
 * @see `SCIWaveXyTransformation`.
 * @see `SCIWaveXyyTransformation`.
 * @see `SCIWaveHlTransformation`.
 * @see `SCIWaveOhlcTransformation`.
 * @see `SCIWaveStackedXyTransformation`.
 */
@interface SCIWaveTransformationBase<__covariant T: SCIXSeriesRenderPassData *>  : SCIBaseRenderPassDataTransformation<T>
...
/**
 * Create new instance of `SCIWaveTransformationBase` class.
 ...
 * @param durationOfStepData Wave duration before next point is started to animate. Default is `0.5`.
 */
- (instancetype)initWithRenderPassDataType:(Class)rpdType zeroLine:(double)zeroLine andDurationOfStep:(float)durationOfStepData NS_DESIGNATED_INITIALIZER;
