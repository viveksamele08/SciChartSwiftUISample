...
//
// SCIBaseColumnRenderableSeries+Protected.h is part of SCICHART®, High Performance Scientific Charts
...
/**
 * The extensions in this header are to be used only by subclasses of `SCIBaseColumnRenderableSeries`.
 */
@interface SCIBaseColumnRenderableSeries ()

@property (strong, nonatomic) SCISmartProperty *fillBrushStyleProperty;
@property (strong, nonatomic) SCISmartPropertyInt *fillBrushMappingModeProperty;
 ...
 * The extensions in this header are to be used only by subclasses of `SCIBaseColumnRenderableSeries`.
 */
@interface SCIBaseColumnRenderableSeries (Protected)
