...
/**
 * Initializes a new instance of `SCIFloatRange`.
...
/**
 * Initializes a new instance of `SCIFloatRange`.
 * @param range The `SCIFloatRange` instance to initialize new range with.
 */
- (instancetype)initWithRange:(SCIFloatRange *)range;
