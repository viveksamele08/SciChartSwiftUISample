...
/**
 * Defines the base class to a Chart Modifier 3D which detects standard touch gestures detected by `UIGestureRecognizer`.
 */
@interface SCIGestureModifierBase3D : SCIChartModifier3DBase<UIGestureRecognizerDelegate>
