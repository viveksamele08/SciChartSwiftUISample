...
//
// SCIYSeriesRenderPassData3D.h is part of SCICHART®, High Performance Scientific Charts
...
#import "SCISeriesRenderPassData3D.h"

/**
 * Defines `SCIYSeriesRenderPassData3D`, the data used in a single render pass by `ISCIRenderableSeries3D` which has Y data
 */
