...
/**
 * Provides a Linear, Category DateTime Axis, capable of rendering Date ticks on the X-Axis of a `SCIChartSurface`.
 * @see `ISCIAxis`.
 * @see `SCIAxisBase`.
 * @see `SCINumericAxis`.
...
/**
 * Default text formatting for `SCICategoryDateAxis`
 */
