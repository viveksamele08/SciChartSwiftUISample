...
//
// SCITouchModifierBase3D+Protected.h is part of SCICHART®, High Performance Scientific Charts
...
/**
 * The extensions in this header are to be used only by subclasses of `SCITouchModifierBase3D`.
 */
@interface SCITouchModifierBase3D ()
