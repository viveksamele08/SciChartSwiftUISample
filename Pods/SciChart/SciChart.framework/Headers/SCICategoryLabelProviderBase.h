...
#import "ISCICategoryLabelProvider.h"
#import "SCICategoryDateAxis.h"

/**
 * Defines a base class for label provider used by category axes.
 */
@interface SCICategoryLabelProviderBase<T : SCICategoryDateAxis *> : SCIFormatterLabelProviderBase<T><ISCICategoryLabelProvider>
