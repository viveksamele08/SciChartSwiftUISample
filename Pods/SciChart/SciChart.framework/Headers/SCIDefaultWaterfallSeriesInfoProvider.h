...
//
// SCIDefaultWaterfallSeriesInfoProvider.h is part of SCICHART®, High Performance Scientific Charts
...
/**
 * Defines a default series info provider for `SCIWaterfallRenderableSeries3D`.
 */
