 ...
 * The extensions in this header are to be used only by subclasses of `SCITranslateXTransformation`.
 */
@interface SCITranslateXTransformation<__covariant T: SCIXSeriesRenderPassData *>(Protected)

/**
 * Applies transformation using SCITranslateXTransformation` transformValues:withOriginalCoordinates:andCurrentDelta:` method. `SCIFloatValues` to be supplied from inheritors.
