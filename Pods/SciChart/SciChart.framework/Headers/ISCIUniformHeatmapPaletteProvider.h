...
//
// ISCIUniformHeatmapPaletteProvider.h is part of SCICHART®, High Performance Scientific Charts
...
/**
 * Gets the value indicating whether `SCIFastUniformHeatmapRenderableSeries` should calculate colors for its render pass data.
 */
