 ...
 */
- (void)addValues:(double *)values count:(NSInteger)count NS_REFINED_FOR_SWIFT;
 ...
 * @param count The amount of values to add.
 */
- (void)addValues:(double *)values startIndex:(NSInteger)startIndex count:(NSInteger)count NS_REFINED_FOR_SWIFT;
