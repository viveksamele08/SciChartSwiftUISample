...
//
// SCICursorCrosshairDrawableBehavior.h is part of SCICHART®, High Performance Scientific Charts
 ...
 */
@interface SCICursorCrosshairDrawableBehavior<__covariant T : SCICursorModifier *> : SCIDrawableBehavior<T>
