...
//
// SCIDefaultMeshSeriesInfoProvider3D.h is part of SCICHART®, High Performance Scientific Charts
...
/**
 * Defines a default series info provider for `SCIContourMeshRenderableSeries3DBase` and inheritors.
 */
