...
//
// SCIFastImpulseRenderableSeries+Protected.h is part of SCICHART®, High Performance Scientific Charts
...
/**
 * The extensions in this header are to be used only by subclasses of `SCIFastImpulseRenderableSeries`.
 */
@interface SCIFastImpulseRenderableSeries (Protected)

/**
 * Creates a new instance of `SCIFastImpulseRenderableSeries` class.
