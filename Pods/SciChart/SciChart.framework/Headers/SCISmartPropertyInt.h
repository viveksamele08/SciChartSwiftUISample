...
//
// SCISmartPropertyInt.h is part of SCICHART®, High Performance Scientific Charts
...
/**
 * Creates a new instance of `SCISmartPropertyInt` class.
 * @param listener The listener change listener for this property.
 */
- (nonnull instancetype)initWithListener:(nonnull SCIIntPropertyChangeListener)listener NS_DESIGNATED_INITIALIZER;
 ...
 */
- (nonnull instancetype)initWithListener:(nonnull SCIIntPropertyChangeListener)listener defaultValue:(int)defaultValue;
