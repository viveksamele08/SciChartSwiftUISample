 ...
 */
@property (nonatomic, nullable) SCIFontStyle * segmentTitleStyle;
/**
 Gets or sets selected title style for segments. Used only if selected title style is nil on segment.
 */
@property (nonatomic, nullable) SCIFontStyle * selectedSegmentTitleStyle;
 ...
 */
-(SCIFontStyle * _Nullable)getTextStyleForSegment:(SCIPieSegment * _Nonnull)segment;
