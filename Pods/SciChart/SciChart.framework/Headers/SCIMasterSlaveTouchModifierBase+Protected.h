...
//
// SCIMasterSlaveTouchModifierBase+Protected.h is part of SCICHART®, High Performance Scientific Charts
...
#import "SCITouchModifierBase+Protected.h"

/**
 * The extensions in this header are to be used only by subclasses of `SCITouchModifierBase`.
 */
@interface SCIMasterSlaveTouchModifierBase (Protected)
 ...
 * - `SCIMasterSlaveTouchModifierBase - `onTouchBegan:`,
 * - `SCIMasterSlaveTouchModifierBase - `onTouchMoved:`,
 * - `SCIMasterSlaveTouchModifierBase - `onTouchEnded:`.
