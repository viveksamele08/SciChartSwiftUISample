...
//
// SCIBoolValues.h is part of SCICHART®, High Performance Scientific Charts
...
/**
 * Creates a new `SCIByteValues` instance.
 * @param capacity The initial capacity.
 */
- (instancetype)initWithCapacity:(NSInteger)capacity NS_DESIGNATED_INITIALIZER;

/**
 * Creates a new `SCIByteValues` instance and initializes it with specified array.
 * @param items The array with items.
 * @param count The count of passed in items.
 */
- (instancetype)initWithItems:(BOOL *)items count:(NSInteger)count NS_REFINED_FOR_SWIFT;

/**
 * Gets the internal items array.
 * @return The items array.
 */
@property (nonatomic, readonly, getter=getItemsArray) BOOL *itemsArray NS_REFINED_FOR_SWIFT;
 ...
 * @param value The value to add.
 */
- (void)insert:(BOOL)value at:(NSInteger)index;
 ...
 */
- (void)addValues:(BOOL *)values count:(NSInteger)count NS_REFINED_FOR_SWIFT;
 ...
 * @param count The amount of values to add.
 */
- (void)addValues:(BOOL *)values startIndex:(NSInteger)startIndex count:(NSInteger)count NS_REFINED_FOR_SWIFT;
 ...
 */
- (void)set:(BOOL)value at:(NSInteger)index;
 ...
 * @return The value.
 */
- (BOOL)getValueAt:(NSInteger)index;
