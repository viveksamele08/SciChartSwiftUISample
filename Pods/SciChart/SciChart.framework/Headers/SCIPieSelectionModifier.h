 ...
 */
@interface SCIPieSelectionModifier : SCIPieGestureModifierBase
...
/**
 * Defines `UITapGestureRecognizer` which is used to detect double tap gestures.
 */
@property (nonatomic, readonly, nonnull) UITapGestureRecognizer *doubleTapRecognizer;
