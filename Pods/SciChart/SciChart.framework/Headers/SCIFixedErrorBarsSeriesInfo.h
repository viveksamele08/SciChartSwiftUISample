 ...
 */
@property (weak, nonatomic) SCIFastFixedErrorBarsRenderableSeries *renderableSeries;
 ...
 */
- (instancetype)initWithSeries:(SCIFastFixedErrorBarsRenderableSeries *)series;
