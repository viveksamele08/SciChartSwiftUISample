...
/**
 * Adds `ISCIEventDispatcher` to this source.
 * @param dispatcher The dispatcher to add.
 */
- (void)addEventDispatcher:(nonnull id<ISCIEventDispatcher>)dispatcher;

/**
 * Removes `ISCIEventDispatcher` from this source.
 * @param dispatcher The dispatcher to remove.
 */
- (void)removeEventDispatcher:(nonnull id<ISCIEventDispatcher>)dispatcher;
