...
//
// SCISplineMountainRenderableSeries+Protected.h is part of SCICHART®, High Performance Scientific Charts
 ...
 */
@interface SCISplineMountainRenderableSeries (Protected)
 ...
 */
- (instancetype)initWithRenderPassData:(SCISplineMountainRenderPassData *)renderPassData hitProvider:(id<ISCIHitProvider>)hitProvider nearestPointProvider:(id<ISCINearestPointProvider>)nearestPointProvider;
