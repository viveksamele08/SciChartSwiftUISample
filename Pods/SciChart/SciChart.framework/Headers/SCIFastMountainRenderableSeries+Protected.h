...
//
// SCIFastMountainRenderableSeries+Protected.h is part of SCICHART®, High Performance Scientific Charts
...
#import "SCIMountainRenderPassData.h"
 ...
 * The extensions in this header are to be used only by subclasses of `SCIFastMountainRenderableSeries`.
 */
@interface SCIFastMountainRenderableSeries (Protected)
 ...
 */
- (instancetype)initWithRenderPassData:(SCIMountainRenderPassData *)renderPassData hitProvider:(id<ISCIHitProvider>)hitProvider nearestPointProvider:(id<ISCINearestPointProvider>)nearestPointProvider;
