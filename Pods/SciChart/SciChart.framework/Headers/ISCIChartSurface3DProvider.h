...
//
// ISCIChartSurface3DProvider.h is part of SCICHART®, High Performance Scientific Charts
 ...
 */
@property (weak, nonatomic, readonly) id<ISCIChartSurface3D> parentSurface;
