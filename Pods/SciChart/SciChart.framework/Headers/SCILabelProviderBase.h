...
/**
 * A base class to define a `LabelProvider`. The LabelProvider may be set onto `ISCIAxisCore.labelProvider` property, allowing programmatic overriding of axis labels.
 */
