...
/**
 * Initializes a new instance of `SCIDoubleRange`.
...
/**
 * Initializes a new instance of `SCIDoubleRange`.
 * @param range The `SCIDoubleRange` instance to initialize new range with.
 */
- (instancetype)initWithRange:(SCIDoubleRange *)range;
