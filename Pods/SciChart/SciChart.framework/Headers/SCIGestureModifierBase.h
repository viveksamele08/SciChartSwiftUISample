...
/**
 * Defines the base class to a Chart Modifier which detects standard touch gestures detected by `UIGestureRecognizer`.
 ...
 */
@interface SCIGestureModifierBase : SCIChartModifierBase<UIGestureRecognizerDelegate>
