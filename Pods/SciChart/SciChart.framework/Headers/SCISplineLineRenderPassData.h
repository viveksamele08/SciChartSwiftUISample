...
//
// SCISplineLineRenderPassData.h is part of SCICHART®, High Performance Scientific Charts
...
/**
 * Defines the `ISCISeriesRenderPassData`, the data used in a single render pass by `SCISplineLineRenderableSeries`.
 */
@interface SCISplineLineRenderPassData : SCISplineXyRenderPassData

/**
 * Creates a new instance of `SCISplineLineRenderPassData` class.
