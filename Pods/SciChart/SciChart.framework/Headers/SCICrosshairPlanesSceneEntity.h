...
//
// SCICrosshairPlanesSceneEntity.h is part of SCICHART®, High Performance Scientific Charts
...
/**
 * Defines a class which is responsible for drawing crosshair planes for `SCITooltipModifier3D` at the hit test point.
 */
@interface SCICrosshairPlanesSceneEntity : SCICrosshairSceneEntityBase

/**
 * Creates a new instance of `SCICrosshairPlanesSceneEntity` class.
