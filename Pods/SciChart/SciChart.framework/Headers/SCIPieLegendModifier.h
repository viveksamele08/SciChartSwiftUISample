 ...
 */
@interface SCIPieLegendModifier : SCIChartModifierBase<ISCIThemeable>
 ...
 */
@property (nonatomic, weak) id<ISCIPieRenderableSeries> pieSeries __deprecated_msg("Please use sourceSeries instead");

/**
 * Pie or donut renderable series which segments `SCIPieLegendModifier` used as dataSource.
 */
@property (nonatomic, weak) id<ISCIPieRenderableSeries> sourceSeries;
