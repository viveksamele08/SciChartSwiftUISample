...
//
// SCICrossDrawableBehavior.h is part of SCICHART®, High Performance Scientific Charts
...
/**
 * Defines a class which is responsible for drawing cross marker for `SCITooltipModifier` at the hit test point.
 * @note `T` is the type of modifier to which this behavior will be attached.
 */
@interface SCICrossDrawableBehavior<__covariant T : SCITooltipModifier *> : SCIDrawableBehavior<T>
/**
