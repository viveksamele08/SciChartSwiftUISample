...
//
// SCIShortValues.h is part of SCICHART®, High Performance Scientific Charts
 ...
 */
- (instancetype)initWithItems:(short *)items count:(NSInteger)count NS_REFINED_FOR_SWIFT;

/**
 * Gets the internal items array.
 * @return The items array.
 */
@property (nonatomic, readonly, getter=getItemsArray) short *itemsArray NS_REFINED_FOR_SWIFT;
 ...
 */
- (void)addValues:(short *)values count:(NSInteger)count NS_REFINED_FOR_SWIFT;
 ...
 * @param count The amount of values to add.
 */
- (void)addValues:(short *)values startIndex:(NSInteger)startIndex count:(NSInteger)count NS_REFINED_FOR_SWIFT;
