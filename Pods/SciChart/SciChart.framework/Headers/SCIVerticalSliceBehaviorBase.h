...
//
// SCIVerticalSliceBehaviorBase.h is part of SCICHART®, High Performance Scientific Charts
 ...
 */
@interface SCIVerticalSliceBehaviorBase<T : id<ISCIChartModifier>> : SCITooltipBehaviorBase<T>

/**
 * Defines the collection of slices.
 */
@property (strong, nonatomic) SCIObservableCollection<SCISlice *> *slices;
