...
@property (nonnull, nonatomic, readonly) SCISmartPropertyFloat *sliceThicknessProperty;

@property (nonnull, nonatomic, readonly) SCISmartProperty *selectedColorMappingProperty;

@property (nonnull, nonatomic, readonly) SCISmartProperty *yColorMappingProperty;
@property (nonnull, nonatomic, readonly) SCISmartProperty *zColorMappingProperty;

@property (nonnull, nonatomic, readonly) SCISmartProperty *yStrokeColorMappingProperty;
@property (nonnull, nonatomic, readonly) SCISmartProperty *zStrokeColorMappingProperty;

@property (nonnull, nonatomic, readonly) SCISmartPropertyInt *clipModeProperty;
